...
class CollectionViewCell: UICollectionViewCell {
    ...
    func setData(image: UIImage, sideOfPictureCell: Double) {
        contentImage.image = image
        contentImage.contentMode = .scaleAspectFill
        contentImage.frame = CGRect(x: 0, y: 0, width: sideOfPictureCell, height: sideOfPictureCell)
    }
}
...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setData(image: (images?[indexPath.row])!, sideOfPictureCell: sideOfPictureCell)
        return cell
    }
